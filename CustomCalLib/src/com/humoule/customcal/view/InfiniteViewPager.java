package com.humoule.customcal.view;
...
public class InfiniteViewPager extends ViewPager
{
	...
	/**
	 * A calendar height is not fixed, it may have 4, 5 or 6 rows. Set fitAllMonths to true so that the calendar will
	 * always have 6 rows
	 */
	private boolean fiveWeeksInCalendar = false;
	...
	public boolean isFiveWeeksInCalendar()
	{
	...
	/**
	 * ViewPager does not respect "wrap_content". The code below tries to measure the height of the child and set the
	 * height of viewpager based on child height
	 * 
	...
	protected void onMeasure(int widthMeasureSpec, int heightMeasureSpec)
	{
		...
		// If fit 5 weeks, we need 5 rows
		if (fiveWeeksInCalendar)
		{
			calHeight = rowHeight * 5;
		}
		else
